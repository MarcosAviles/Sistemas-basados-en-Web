<?php
include_once('../controladores/DB.php');
include_once('../controladores/formato.php');
include_once('../controladores/GestionPortada.php');
include_once('../controladores/GestionNoticias.php');
include_once('../controladores/GestionRSS.php');
include_once('../controladores/GestionMenu.php');
include_once('../controladores/GestionHeader.php');
include_once('../controladores/GestionOrganizacion.php');
include_once('../controladores/GestionLogin.php');
include_once('../controladores/GestionRegistro.php');
include_once('../controladores/GestionAnuncios.php');
include_once('../controladores/GestionCategorias.php');
include_once('../controladores/Fecha.php');
